...
impl<'a> CodeGenerator<'a> {
    ...
    fn generate(mut self) -> String {
        self.output
            .push_str("// Generated by lolserialize. Do not edit.\n\n");
        self.output
            .push_str("use lolserialize_runtime as __rt;\n\n");
    ...
    fn gen_struct(&mut self, s: &Struct) {
        ...
        writeln!(self.output, "#[cfg_attr(feature = \"serde\", derive(serde::Serialize, serde::Deserialize))]").unwrap();
        ...
        if let Some(size) = self.struct_fixed_size(s) {
            writeln!(self.output, "    const FIXED_SIZE: ::core::option::Option<usize> = ::core::option::Option::Some({});", size).unwrap();
        }
        writeln!(self.output, "}}").unwrap();
    }
    ...
    fn gen_union(&mut self, u: &Union) {
        ...
        writeln!(self.output, "#[cfg_attr(feature = \"serde\", derive(serde::Serialize, serde::Deserialize))]").unwrap();
        writeln!(self.output, "#[cfg_attr(feature = \"serde\", serde(tag = \"$tag\", content = \"$value\"))]").unwrap();
        writeln!(self.output, "pub enum {} {{", name).unwrap();
        ...
        writeln!(
            self.output,
            "        let tag = __rt::decode_leb128_u64(buf)?;"
        )
        .unwrap();
        writeln!(
            self.output,
